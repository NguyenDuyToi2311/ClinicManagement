...
@Component({
  selector: 'app-finish-dt',
  templateUrl: './finish-dt.component.html',
  styleUrls: ['./finish-dt.component.css',
...
export class FinishDtComponent implements OnInit {
  id: number = 0
  userData = new User()
  ...
  loadDetail() {
    ...
    this.service.getDoctorFinish(this.userData.UserId).subscribe(data => {
      this.finish = data
