...
@Component({
  selector: 'app-list-medicalrecord',
  templateUrl: './list-medicalrecord.component.html',
  styleUrls: ['./list-medicalrecord.component.css',
...
export class ListMedicalrecordComponent implements OnInit {
  ...
  loadDetail() {
    ...
    this.service.getMedicalRecordPatient(this.id).subscribe(data => {
